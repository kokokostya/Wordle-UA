...
function App(props) {
  ...
  React.useEffect(function () {
    ...
    // if (UID == "lrn4kdwy1laxgo014" && stats.games < 218) {
    //   localStorage.setItem("stats", JSON.stringify({games:218,won:216,streak:100,maxStreak:100,attempts:{1:0,2:5,3:46,4:72,5:67,6:26}}));
    // }
  }, [UID]);
