...
function Modal(props) {
  ...
  if (props.type == "help") {
    ...
    }, props.averageStats.league.leaderboard.map(leader => /*#__PURE__*/React.createElement(GraphBarVertical, {
      uid: leader.uid,
      pos: leader.pos,
      value: leader.streak,
      myUid: props.uid,
    ...
    }, props.averageStats.allTimeTop.map(leader => /*#__PURE__*/React.createElement(GraphBarVertical, {
      uid: leader.uid,
      pos: leader.pos,
