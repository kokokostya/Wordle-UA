...
function App(props) {
  ...
  React.useEffect(function () {
    ...
    // if (UID == "lr31r12v321mx82pv" && stats.games < 107) {
    //   localStorage.setItem("stats", JSON.stringify({games:107,won:97,streak:2,maxStreak:51,attempts:{1:1,2:2,3:9,4:12,5:38,6:34}}));
    // }
  }, [UID]);
