...
function App(props) {
  ...
  React.useEffect(function () {
    ...
    // if (UID == "ljds9jeg22ect9s1y" && stats.games < 356) {
    //   localStorage.setItem("stats", JSON.stringify({games:356,won:352,streak:8,maxStreak:207,attempts:{1:2,2:20,3:76,4:146,5:76,6:32}}));
    // }
  }, [UID]);
