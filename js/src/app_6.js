  ...
  return (
    <React.Fragment>
      <header>
        ...
        <ul>
          <li><a href="/5.html" className={(lettersLimit == 5) && "active"}>5</a></li>
          <li><a href="/6.html" className={(lettersLimit == 6) && "active"}>6</a></li>
        </ul>
      ...
      <main id="board-container">
        <div id="board" className={"letters-" + lettersLimit}>
