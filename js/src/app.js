function App(props) {
  ...
  React.useEffect(() => {
    ...
    // if (UID == "lk1hh2pr36g36jsvv" && stats.games < 11) {
    //   localStorage.setItem("stats", JSON.stringify({games:26,won:25,streak:5,maxStreak:17,attempts:{1:0,2:0,3:7,4:8,5:7,6:3}}));
    // }
  }, [UID]);
