function App(props) {
  ...
  function checkWord() {
    ...
    var solution = props.words[currentIssueNumber-1];
...
function Modal(props) {
  ...
  if (props.type == "help") {
    ...
    content = <React.Fragment>
      <p><b>Вгадайте слово з 6 спроб.</b> Кожна здогадка мусить бути словарним іменником, але не власною назвою. Після кожної спроби колір підкаже, наскільки близько ви були:</p>
