function App(props) {
  ...
  React.useEffect(() => {
    ...
    // if (UID == "ls5sigsj18sfrc9tr" && stats.games < 393) {
    //   localStorage.setItem("stats", JSON.stringify({games:393,won:393,streak:393,maxStreak:393,attempts:{1:0,2:26,3:107,4:180,5:59,6:21}}));
    // }
  }, [UID]);
